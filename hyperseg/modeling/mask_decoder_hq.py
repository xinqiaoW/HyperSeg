...
class MaskDecoderHQ(nn.Module):
    def __init__(
        ...
        *,
        ...
        # self.tao = nn.Parameter(torch.tensor(4.0), requires_grad=True)

    def forward(
        self,
        image_embeddings_rgb: torch.Tensor,
        image_pe: torch.Tensor,
        sparse_prompt_embeddings: torch.Tensor,
        dense_prompt_embeddings: torch.Tensor,
        # beta_my: torch.Tensor = None,
        ...
        masks, iou_pred = self.predict_masks(
            image_embeddings_rgb=image_embeddings_rgb,
            image_pe=image_pe,
    ...
    def predict_masks(
        ...
        src = torch.repeat_interleave(image_embeddings_rgb, 1, dim=0)

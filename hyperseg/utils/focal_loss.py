...
#         alpha = target * (2 * self.alpha - 1) + (1 - self.alpha)
#         one_minus_probs = target * (1 - probs) + (1 - target) * probs

#         focal_weight = torch.pow(one_minus_probs, self.gamma)
